...
## Mission Control online runbook/template — Apr 30, 2026
- Added `.env.production.template` with non-secret production env placeholders for the preferred `mission.companytheatre.ca` shape.
